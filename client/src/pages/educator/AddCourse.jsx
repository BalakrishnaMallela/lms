    ...
    justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-md w-full text-gray-500">
        <div className="flex flex-col gap-1">
          ...
          type="text" placeholder="Type here" className="outline-none md:py-2.5 py-2
          ...
          <div className="flex items-center justify-between flex-wrap">
            <div className="flex flex-col gap-1">
              ...
              w-28 px-3 rounded border bporder-gray-500" required/>
            </div>
                   ...
                   <div className="flex items-center">
                    <img src={assets.dropdown_icon} alt="" width={14} className=
                      {`mr-2 cursor-pointer transition-all ${chapter.collapsed &&
                        "-rotate-90"}`} onClick={()=>handleChapter("toggle",chapter.chapterId)} />
